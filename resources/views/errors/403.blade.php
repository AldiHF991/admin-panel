...
<head>
    ...
    <title>Akses Ditolak - BBWS Brantas</title>
...
<body>
    <div class="error-container">
        ...
        <div class="error-details">
            ...
            <p class="mt-2">
                Jika Anda adalah Administrator dan masih melihat pesan ini, 
                silakan hubungi administrator sistem atau coba login ulang.
            </p>
        </div>
