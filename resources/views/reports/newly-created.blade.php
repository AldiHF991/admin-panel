...
<head>
    ...
    <title>{{ $title ?? 'Laporan Rapat Baru Dibuat' }}</title>
    ...
    <style>
        ...
        .report-header {
            background: linear-gradient(135deg, #198754, #157347); /* Warna hijau */
            color: white;
            padding: 3rem 1.5rem;
            border-radius: .75rem;
...
<body>
    <div class="container py-4">
        <div class="print-header" style="display: none;">
            ...
            <div>
                <h4 class="fw-bold mb-1">Laporan Rapat Baru Dibuat</h4>
        ...
        <div class="report-header text-center mb-4 no-print">
            <h1 class="display-6 fw-bold">Laporan Rapat Baru Dibuat</h1>
        ...
        <div class="card border-0 shadow-sm mb-4 no-print">
            <div class="card-body text-center">
                ...
                <h3 id="realtime-clock-time" class="fw-bold text-success mb-0"></h3>
            </div>
        </div>
